      ...
      "body": [
        {
          ...
          "ci_unique_id": "100533",
          "message": "BuildNumber : '$BUILD_NUMB', BuildStatus : FAIL, ApplicationName : \"TIXCHANGE Web\", GIT_COMMIT_MESSAGE : North America 5G provisioning Feature Flag Enabled, jenkinsPluginName : CAAPM",
          "timestamp": "'$UTC_TIME'",
          "status": "NEW"
        }
      ]
...
BUILD_NUMB=$[$BUILD_NUMB+1]

echo $BUILD_NUMB > /root/TixChangeWithHelmKubeSpray/CustomJenkinsEvent/currentBuildNumb
